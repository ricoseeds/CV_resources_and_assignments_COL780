...
int main(int argc, char** argv)
{
	...
	for (;;)
	{
		...
		if ( key_input == 's' ) { // Save when S is pressed.

			sprintf_s(filename, "C:/Projects/Acads/COL780/data/calib_images/Frame_%d.jpg", c);
			cv::waitKey(10);
		...
		if (key_input == 27) break; // stop capturing by pressing ESC 
	}
